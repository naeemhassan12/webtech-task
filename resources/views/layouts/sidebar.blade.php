<div class="sidebar d-flex flex-column h-100">
    <div class="p-4">
        <h5 class="fw-bold mb-0 text-primary"><a href="{{ route('dashboard') }}">WebTechFusion</a></h5>
    </div>
    ...
    <div class="flex-grow-1 px-3">
        ...
        <ul class="nav flex-column gap-1" id="sidebarPendingTasks">
        ...
        <ul class="nav flex-column gap-1" id="sidebarActiveTasks">
